...
import 'package:inventario/pages/Administrador/views/inventario/ver_soluciones.dart';
    ...
    builder: (context) => AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () async {
            try {
              await _databaseServices.deleteSolucionesLimpiadoras(widget.solucionId); // 🔴 Elimina en Firestore
              if (mounted) {
                Navigator.pop(context);

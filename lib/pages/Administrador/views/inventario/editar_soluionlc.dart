...
import 'package:inventario/pages/Administrador/views/inventario/ver_solucion_lc.dart';
import 'package:inventario/services/database_services.dart';
import 'package:inventario/pages/Administrador/views/inventario/lista_solucioneslc.dart';
...
void _eliminarSolucionLC() {
  showDialog(
    context: context,
    builder: (context) => AlertDialog(
      backgroundColor: Colors.white,
      title: const Text('Eliminar'),
      content: const Text('¿Estás seguro de que deseas eliminar esta solución?'),
      actions: [
        TextButton(
        ...
        ElevatedButton(
          onPressed: () async {
            try {
              await _databaseServices.deleteSolucionLC(widget.solucionId);
              if (mounted) {
                Navigator.pop(context);
        ...
        children: [
          ...
          Center(
            child: Wrap(
              ...
              children: [
                _buildCardEditar(Icons.edit, 'Editar Solución', _mostrarFormularioEdicion),
                _buildCardVer(Icons.visibility, 'Ver Soluciones', () => _verSoluciones(widget.solucionId, widget.marca)),
                _buildCardAgregar(Icons.add, 'Agregar Solución', _agregarSolucion),
              ],
            ),
          ),
          ...
          Center(
            child: IconButton(
              ...
              onPressed: _eliminarSolucionLC,
              tooltip: 'Eliminar Solución',
            ),
          ),
        ],
      ),

...
import 'package:inventario/pages/Administrador/views/inventario/ver_plaquetas.dart';
...
void _eliminarPlaqueta() {
  showDialog(
    context: context,
    builder: (context) => AlertDialog(
      backgroundColor: Colors.white,
      title: const Text('Eliminar Plaqueta'),
      content: const Text('¿Estás seguro de que deseas eliminar esta plaqueta? Esta acción no se puede deshacer.'),
      actions: [
        TextButton(
        ...
        ElevatedButton(
          onPressed: () async {
            try {
              await _databaseServices.deletePlaqueta(widget.plaquetaId); // 🔹 Elimina en Firestore
              if (mounted) {
                Navigator.pop(context);
                widget.onNavigate(ListaPlaquetas(onNavigate: widget.onNavigate)); // 🔄 Redirige a la lista
                ScaffoldMessenger.of(context).showSnackBar(
        ...
        children: [
          ...
          Center(
            child: Wrap(
              ...
              children: [
                _buildCardEditar(Icons.edit, 'Editar Plaqueta', _mostrarFormularioEdicion),
                _buildCardVer(Icons.visibility, 'Ver Plaquetas', () => _verPlaquetas(widget.plaquetaId, widget.marca)),
                _buildCardAgregar(Icons.add, 'Agregar Plaqueta', _agregarPlaqueta),
              ],
            ),
          ),
          ...
          Center(
            child: IconButton(
              ...
              onPressed: _eliminarPlaqueta,
              tooltip: 'Eliminar Plaqueta',
            ),
          ),
        ],
      ),

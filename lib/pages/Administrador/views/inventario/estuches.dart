...
import 'package:inventario/pages/Administrador/views/inventario/agregar_estuche.dart';
import 'package:inventario/pages/Administrador/views/inventario/lista_estuches.dart';

class Estuches extends StatefulWidget {
  final Function(Widget) onNavigate;

  const Estuches({super.key, required this.onNavigate});

  @override
  State<Estuches> createState() => _EstuchesState();
}

class _EstuchesState extends State<Estuches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Estuches', 
          style: TextStyle(
            color: Colors.black, 
            fontSize: 24,
                ...
                children: [
                  ...
                  if (screenWidth < 600) ...[
                    _buildCard(
                      ...
                      iconSize: iconSize,
                      textSize: textSize,
                      title: "Lista estuches",
                      icon: Icons.indeterminate_check_box,
                      color: Colors.black,
                      onTap: () => widget.onNavigate(ListaEstuches(onNavigate: widget.onNavigate)),),
                    ...
                    _buildCard(
                      ...
                      iconSize: iconSize,
                      textSize: textSize,
                      title: "Agregar estuche",
                      icon: Icons.add_circle_outline,
                      color: const Color(0xFFD4AF37),
                      onTap: () => widget.onNavigate(AgregarEstuche(onNavigate: widget.onNavigate)),),
                  ] else ...[

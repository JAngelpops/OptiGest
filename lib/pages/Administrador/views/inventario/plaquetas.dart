...
import 'package:inventario/pages/Administrador/views/inventario/agregar_plaqueta.dart';
import 'package:inventario/pages/Administrador/views/inventario/lista_plaquetas.dart';

class Plaquetas extends StatefulWidget {
  final Function(Widget) onNavigate;

  const Plaquetas({super.key, required this.onNavigate});

  @override
  State<Plaquetas> createState() => _PlaquetasState();
}

class _PlaquetasState extends State<Plaquetas> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Plaquetas', 
          style: TextStyle(
            color: Colors.black, 
            fontSize: 24,
                ...
                children: [
                  ...
                  if (screenWidth < 600) ...[
                    _buildCard(
                      ...
                      iconSize: iconSize,
                      textSize: textSize,
                      title: "Lista Plaquetas",
                      icon: Icons.visibility,
                      color: Colors.black,
                      onTap: () => widget.onNavigate(ListaPlaquetas(onNavigate: widget.onNavigate)),),
                    ...
                    _buildCard(
                      ...
                      iconSize: iconSize,
                      textSize: textSize,
                      title: "Agregar Plaqueta",
                      icon: Icons.add_circle_outline,
                      color: const Color(0xFFD4AF37),
                      onTap: () => widget.onNavigate(AgregarPlaqueta(onNavigate: widget.onNavigate)),),
                  ] else ...[

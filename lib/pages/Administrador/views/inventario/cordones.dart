...
import 'package:inventario/pages/Administrador/views/inventario/agregar_cordon.dart';
import 'package:inventario/pages/Administrador/views/inventario/lista_cordones.dart';

class Cordones extends StatefulWidget {
  final Function(Widget) onNavigate;

  const Cordones({super.key, required this.onNavigate});

  @override
  State<Cordones> createState() => _CordonesState();
}

class _CordonesState extends State<Cordones> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cordones', 
          style: TextStyle(
            color: Colors.black, 
            fontSize: 24,
                ...
                children: [
                  ...
                  if (screenWidth < 600) ...[
                    _buildCard(
                      ...
                      iconSize: iconSize,
                      textSize: textSize,
                      title: "Lista Cordones",
                      icon: Icons.indeterminate_check_box,
                      color: Colors.black,
                      onTap: () => widget.onNavigate(ListaCordones(onNavigate: widget.onNavigate)),
                    ),
                    ...
                    _buildCard(
                      ...
                      iconSize: iconSize,
                      textSize: textSize,
                      title: "Agregar Cordón",
                      icon: Icons.add_circle_outline,
                      color: const Color(0xFFD4AF37),
                      onTap: () => widget.onNavigate(AgregarCordon(onNavigate: widget.onNavigate)),
                    ),
                  ] else ...[

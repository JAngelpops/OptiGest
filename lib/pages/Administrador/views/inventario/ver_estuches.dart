...
void _eliminarEstuche(String estucheId) {
  showDialog(
    context: context,
    builder: (context) => AlertDialog(
      backgroundColor: Colors.white,
      title: const Text('Eliminar Estuche'),
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () async {
            try {
              await FirebaseFirestore.instance.collection('estuches').doc(estucheId).delete();
              if (mounted) {
                setState(() {
                  _estuches.removeWhere((doc) => doc.id == estucheId);
                });
                Navigator.pop(context);
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () => _eliminarEstuche(_estuches[index].id),
                                    ),
                                  ],
                                ),
                              ],

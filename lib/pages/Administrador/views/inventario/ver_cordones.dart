...
void _eliminarCordon(String cordonId) {
  showDialog(
    context: context,
    builder: (context) => AlertDialog(
      backgroundColor: Colors.white,
        ...
        ElevatedButton(
          onPressed: () async {
            try {
              ...
              if (mounted) {
                setState(() {
                  _cordones.removeWhere((cordon) => cordon.id == cordonId);
                });
                Navigator.pop(context);
              ...
              print("❌ Error al eliminar cordón: $e");
              ScaffoldMessenger.of(context).showSnackBar(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () => _eliminarCordon(_cordones[index].id),
                                    ),
                                  ],
                                ),
                              ],

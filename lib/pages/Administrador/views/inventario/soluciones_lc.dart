...
import 'package:inventario/pages/Administrador/views/inventario/agregar_solucionlc.dart';
import 'package:inventario/pages/Administrador/views/inventario/lista_solucioneslc.dart';

class SolucionesLc extends StatefulWidget {
  final Function(Widget) onNavigate;

  const SolucionesLc({super.key, required this.onNavigate});

  @override
  State<SolucionesLc> createState() => _SolucionesLcState();
}

class _SolucionesLcState extends State<SolucionesLc> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Soluciones L.C.', 
          style: TextStyle(
            color: Colors.black, 
            fontSize: 24,
                ...
                children: [
                  ...
                  if (screenWidth < 600) ...[
                    _buildCard(
                      ...
                      color: Colors.black,
                      onTap: () => widget.onNavigate(ListaSolucioneslc(onNavigate: widget.onNavigate)),
                    ),
                    ...
                    _buildCard(
                      ...
                      onTap: () => widget.onNavigate(AgregarSolucionlc(onNavigate: widget.onNavigate)),)
                  ] else ...[

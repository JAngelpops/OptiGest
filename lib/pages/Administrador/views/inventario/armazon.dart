...
import 'package:inventario/pages/Administrador/views/inventario/agregar_armazon.dart';
...
class Armazon extends StatefulWidget {
  ...
  const Armazon({super.key, required this.onNavigate});
                ...
                children: [
                  ...
                  if (screenWidth < 600) ...[
                    _buildCard(
                      ...
                      iconSize: iconSize,
                      textSize: textSize,
                      title: "Lista armazones",
                      icon: Icons.visibility,
                      color: Colors.black,
                      onTap: () => widget.onNavigate(ListaArmazones(onNavigate: widget.onNavigate)),),
                    ...
                    _buildCard(
                      ...
                      onTap: () => widget.onNavigate(AgregarArmazon(onNavigate: widget.onNavigate)),),
                  ] else ...[

...
Future<void> _generarPDF() async {
  ...
  final ByteData decoracionSuperiorData = await rootBundle.load('assets/decoracionSuperior.png');
  final Uint8List decoracionSuperiorBytes = decoracionSuperiorData.buffer.asUint8List();
  final pw.MemoryImage decoracionSuperiorImage = pw.MemoryImage(decoracionSuperiorBytes);

  final ByteData decoracionInferiorData = await rootBundle.load('assets/decoracionInferior.png');
  final Uint8List decoracionInferiorBytes = decoracionInferiorData.buffer.asUint8List();
  final pw.MemoryImage decoracionInferiorImage = pw.MemoryImage(decoracionInferiorBytes);
        ...
        return pw.Stack(
          children: [
            ...
            pw.Positioned(
              ...
              right: -70,
              child: pw.Container(
                width: 300, // Ajusta según el tamaño de tu imagen
                height: 300,
                child: pw.Image(
                  decoracionSuperiorImage,
            ...
            pw.Positioned(
              ...
              left: -70,
              child: pw.Container(
                width: 320, // Ajusta según el tamaño de tu imagen
                height: 320,
                child: pw.Image(
                  decoracionInferiorImage,
                  fit: pw.BoxFit.contain,
                ),
              ),
            ),

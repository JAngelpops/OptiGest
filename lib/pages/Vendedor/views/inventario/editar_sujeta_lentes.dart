...
import 'package:inventario/pages/Vendedor/views/inventario/ver_sujeta_lentes.dart';
      ...
      Center( 
        child: Wrap(
          ...
          children: [
            ...
            _buildCardVer(Icons.visibility, 'Ver', () => _verSujetaLentes(widget.sujetaLentesId, widget.marca)),
            _buildCardAgregar(Icons.add, 'Agregar', _agregarSujetaLente),
          ],
        ),
      ),
    ],

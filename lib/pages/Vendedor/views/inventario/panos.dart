...
import 'package:inventario/pages/Vendedor/views/inventario/agregar_pano.dart';
import 'package:inventario/pages/Vendedor/views/inventario/lista_panos.dart';

class Panos extends StatefulWidget {
  final Function(Widget) onNavigate;

  const Panos({super.key, required this.onNavigate});

  @override
  State<Panos> createState() => _PanosState();
}

class _PanosState extends State<Panos> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paños', 
          style: TextStyle(
            color: Colors.black, 
            fontSize: 24,
                ...
                children: [
                  ...
                  if (screenWidth < 600) ...[
                    _buildCard(
                      ...
                      color: Colors.black,
                      onTap: () => widget.onNavigate(ListaPanos(onNavigate: widget.onNavigate)),),
                    ...
                    _buildCard(
                      ...
                      onTap: () => widget.onNavigate(AgregarPano(onNavigate: widget.onNavigate)),),
                  ] else ...[

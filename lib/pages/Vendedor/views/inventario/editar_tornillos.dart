...
import 'package:inventario/pages/Vendedor/views/inventario/ver_tornillos.dart';
      ...
      Center( 
        child: Wrap(
          ...
          children: [
            ...
            _buildCardVer(Icons.visibility, 'Ver', () => _verTornillos(widget.tornilloId, widget.marca)),
            _buildCardAgregar(Icons.add, 'Agregar', _agregarTornillo),
          ],
        ),
      ),
    ],

...
import 'package:inventario/pages/Vendedor/views/inventario/ver_estuches.dart';
      ...
      Center( 
        child: Wrap(
          ...
          children: [
            ...
            _buildCardVer(Icons.visibility, 'Ver', () => _verEstuches(widget.estucheId, widget.marca)),
            _buildCardAgregar(Icons.add, 'Agregar', _agregarEstuche),
          ],
        ),
      ),
    ],

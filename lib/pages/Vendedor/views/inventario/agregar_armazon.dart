...
class AgregarArmazon extends StatefulWidget {
  final Function(Widget) onNavigate;

  const AgregarArmazon({super.key, required this.onNavigate});

  @override
  State<AgregarArmazon> createState() => _AgregarArmazonState();
}

class _AgregarArmazonState extends State<AgregarArmazon> {
  ...
  void _guardarArmazon() async {
    ...
    try {
      await _databaseServices.addArmazon(armazonData);
      widget.onNavigate(Armazon(onNavigate: widget.onNavigate));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error al guardar el armazón: $e')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Agregar armazón', style: TextStyle(color: Colors.black, fontSize: 24, fontWeight: FontWeight.bold)),
        centerTitle: true,

...
import 'package:inventario/pages/Vendedor/views/inventario/ver_cordones.dart';
      ...
      Center( 
        child: Wrap(
          ...
          children: [
            ...
            _buildCardVer(Icons.visibility, 'Ver', () => _verCordones(widget.cordonId, widget.marca)),
            _buildCardAgregar(Icons.add, 'Agregar', _agregarCordon),
          ],
        ),
      ),
    ],

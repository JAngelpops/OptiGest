...
class AgregarCordon extends StatefulWidget {
  final Function(Widget) onNavigate;
  const AgregarCordon({super.key, required this.onNavigate});

  @override
  State<AgregarCordon> createState() => _AgregarCordonState();
}

class _AgregarCordonState extends State<AgregarCordon> {
  ...
  void _guardarCordon() async {
    ...
    try {
      await _databaseServices.addCordon(cordonData);
      widget.onNavigate(Cordones(onNavigate: widget.onNavigate));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error al guardar el cordón: $e')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Agregar cordón', style: TextStyle(color: Colors.black, fontSize: 24, fontWeight: FontWeight.bold)),
        centerTitle: true,

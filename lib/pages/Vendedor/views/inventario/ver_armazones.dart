                ...
                builder: (context, constraints) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      var lente = _lentes[index].data() as Map<String, dynamic>? ?? {};

                      return InkWell(
                        onTap: () {
                          lente['id'] = _lentes[index].id;
                          _mostrarFormularioEdicion(lente);
                        },
                        child: Card(
                          color: Colors.white,
                          elevation: 4,

...
class AgregarSujetaLentes extends StatefulWidget {
  final Function(Widget) onNavigate;
  const AgregarSujetaLentes({super.key, required this.onNavigate});

  @override
  State<AgregarSujetaLentes> createState() => _AgregarSujetaLentesState();
}

class _AgregarSujetaLentesState extends State<AgregarSujetaLentes> {
  ...
  void _guardarSujetaLentes() async {
    ...
    try {
      await _databaseServices.addSujetaLentes(sujetaLentesData);
      widget.onNavigate(SujetaLentes(onNavigate: widget.onNavigate));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error al guardar el sujeta lentes: $e')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Agregar sujeta lentes', style: TextStyle(color: Colors.black, fontSize: 24, fontWeight: FontWeight.bold)),
        centerTitle: true,
                              ...
                              children: [
                                ...
                                Center(
                                  child: ElevatedButton(
                                    ...
                                    onPressed: _guardarSujetaLentes,
                                    child: const Text(
                                      'Guardar',

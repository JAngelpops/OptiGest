...
import 'package:inventario/pages/Vendedor/views/inventario/lista_panos.dart';
import 'package:inventario/pages/Vendedor/views/inventario/ver_panos.dart';
      ...
      Center( 
        child: Wrap(
          ...
          children: [
            ...
            _buildCardVer(Icons.visibility, 'Ver', () => _verPanos(widget.panoId, widget.marca)),
            _buildCardAgregar(Icons.add, 'Agregar', _agregarPano),
          ],
        ),
      ),
    ],
